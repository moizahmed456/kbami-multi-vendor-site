  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content flat">
      ...
      <ul class="nav nav-tabs">
        ...
        <li><a data-toggle="tab" href="#menu1">Merchant</a></li>
      </ul>
      <div class="tab-content">
        ...
        <div id="menu1" class="tab-pane fade">
          <!--<h3>Vendors</h3>-->
          <a class="btn btn-link" href="https://kbami.com/register">Register as a merchant</a>
          <a class="btn btn-link" href="https://kbami.com/login">Login as a merchant</a>
        </div>
      </div>
